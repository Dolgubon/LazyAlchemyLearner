...
LazyLearner.strings = {
    ...
    LL_TRAIT_SELECTION = "Trait Selection",
    ...
    LL_QUEUE = "Queue",
    LL_QUEUE_TRAITS = "Queue up a selection of poisons to create when you visit an alchemy station in order to learn the ingredient traits.",
    LL_VISIT_ALCHEMY_STATION = "Visit an Alchemy Station to learn queued alchemy traits",
    LL_RUNES_SELECTION = "Runes Selection",
